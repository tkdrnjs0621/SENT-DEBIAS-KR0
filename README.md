...
- An implementation of [SEAT-TEST on Korean Language Models](https://github.com/tkdrnjs0621/SEAT-TEST-KR0), which is also a part of this project, is based on this repository
...
## Data
[모두의 말뭉치 문어 말뭉치](https://corpus.korean.go.kr/) from 국립국어원 has been used for GBS dataset.

[문서요약 텍스트](https://aihub.or.kr/aidata/8054) from aihub has been used for GKR dataset.
...
## Usage
The demo can be demonstrated by executing the jupyter notebook `DEMO.ipynb`.
